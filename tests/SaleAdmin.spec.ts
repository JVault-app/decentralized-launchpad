...
describe('Ico', () => {
    ...
    it('should deploy ico sale', async () => {
        let res = await user1JettonWalletAddress.sendTransfer(user1.getSender(), toNano(2), toNano(100), adminAddress.address, user1.address, null, toNano(1), SaleAdmin.createRequestSaleDeployMessage(conf))
